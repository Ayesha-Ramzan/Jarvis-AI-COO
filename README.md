...
tests/test_migrations.py::test_all_revision_ids_fit_alembic_version_column PASSED [ 17%]
...
tests/test_skills.py::test_same_org_list_only_shows_own_skills PASSED    [ 24%]
tests/test_skills.py::test_draft_can_be_updated_in_place PASSED          [ 26%]
tests/test_skills.py::test_cross_org_read_is_denied PASSED               [ 29%]
tests/test_skills.py::test_cross_org_update_is_denied PASSED             [ 31%]
tests/test_skills.py::test_cross_org_activate_is_denied PASSED           [ 34%]
tests/test_skills.py::test_cross_org_version_creation_is_denied PASSED   [ 36%]
tests/test_skills.py::test_unknown_organization_is_rejected PASSED       [ 39%]
tests/test_skills.py::test_member_claiming_owner_in_header_is_still_denied PASSED [ 41%]
tests/test_skills.py::test_owner_with_member_header_role_still_activates PASSED [ 43%]
tests/test_skills.py::test_bogus_role_header_is_ignored PASSED           [ 46%]
tests/test_skills.py::test_non_member_user_is_rejected PASSED            [ 48%]
tests/test_skills.py::test_non_owner_activation_is_denied PASSED         [ 51%]
tests/test_skills.py::test_non_owner_disable_is_denied PASSED            [ 53%]
tests/test_skills.py::test_draft_skill_is_not_returned_by_department_runtime PASSED [ 56%]
tests/test_skills.py::test_disabled_skill_is_excluded_from_runtime_selection PASSED [ 58%]
tests/test_skills.py::test_disabled_skill_cannot_be_reactivated PASSED   [ 60%]
tests/test_skills.py::test_disable_is_idempotent PASSED                  [ 63%]
tests/test_skills.py::test_active_skill_cannot_be_modified_in_place PASSED [ 65%]
tests/test_skills.py::test_active_version_is_immutable_new_version_required PASSED [ 68%]
tests/test_skills.py::test_draft_skill_cannot_accept_new_versions PASSED [ 70%]
tests/test_skills.py::test_version_rows_carry_organization_id PASSED     [ 73%]
tests/test_skills.py::test_activation_of_foreign_version_is_denied PASSED [ 75%]
